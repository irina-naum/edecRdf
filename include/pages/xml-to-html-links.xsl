...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="res:uri">
        ...
        -->
        <xsl:variable name="query">SELECT%20%28%3C<xsl:value-of select="$x"/>%3E%20AS%20%3Fsubject%29%20%3Fpredicate%20%3Fobject%20%7B%3C<xsl:value-of
                select="$x"/>%3E%20%3Fpredicate%20%3Fobject%20%7D
        </xsl:variable>
        <xsl:text>&lt;</xsl:text>
